...
underscore ("_") or ending in ".ijm", are installed in the Plugins menu.
Examples of such macros can be found in the ImageJ/plugins/Macros folder.
...
starts. For examples showing how macros can be assigned keyboard
shortcuts, refer to the "MacroSet.txt" file. Note that macro shortcuts only
